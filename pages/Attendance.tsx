...
const Attendance: React.FC = () => {
    ...
    // Get subjects (from professor or all if admin)
    const subjects = currentUser?.role === UserRole.PROFESSOR
        ? currentUser.subjects || []
        : ['Teologia Sistemática', 'Hermenêutica', 'Homilética', 'História da Igreja', 'Grego Bíblico']; // Fallback/Admin list
